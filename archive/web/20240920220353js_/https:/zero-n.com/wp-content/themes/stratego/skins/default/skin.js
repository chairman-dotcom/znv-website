...
(function() {
	...
	jQuery( document ).on(
		'action.ready_stratego', function() {
	...
	jQuery( document ).on(
		'action.scroll_stratego', function() {
	...
	jQuery( document ).on(
		'action.resize_stratego', function() {
			extra_margin_top_video_popup_button();
			stratego_skin_post_header_init();
			skin_add_custom_width_filter_list();
...
/*
     FILE ARCHIVED ON 21:39:53 Sep 20, 2024 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 03:20:17 Aug 12, 2025.
...
playback timings (ms):
  ...
  esindex: 0.01
  cdx.remote: 309.418
  LoadShardBlock: 167.839 (3)
  PetaboxLoader3.datanode: 220.63 (5)
  load_resource: 269.767 (2)
  PetaboxLoader3.resolve: 139.744 (2)
*/